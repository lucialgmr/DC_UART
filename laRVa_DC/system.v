...
/*
    ...
    0xE0000004 | UART Baud Divider |  UART flags
	           |                   |
	0xE0000040 | OUTPUT_REG		   |  OUTPUT_REG	changed_AAG
	           |                   |
...
module SYSTEM (
	...
	output [31:0] salida,	//changed_AAG
...
assign salida = outreg;	//changed_AAG
...
always@*
 casex (ca[7:2])
	...
	6'b010xxx: iodo<=outreg;	//lectura GPO changed_AAG
...
/////////////////////////////////
/////GPO output reg (esta será mi etiqueta para encontrar facilmente los cambios que he hecho) changed_AAG
reg [31:0] outreg;
wire [3:0] owr;
